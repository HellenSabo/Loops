programa
{
	...
	funcao inicio()
	{real sal = 0
		...
		para(i=0; i<2; i++)
		{
		    escreva("Olá! A prefeitura está fazendo uma pesquisa! Por favor, informe seu salário: R$ ")
		    leia(sal)
		    somaSal = somaSal + sal
		...
		escreva("\nO percentual de pessoas entrevistadas com salário inferior ou igual a R$ 100,00 é: ", per)
